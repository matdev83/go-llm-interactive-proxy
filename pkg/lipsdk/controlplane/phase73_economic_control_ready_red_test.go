...
func TestPhase73_EconomicControlReadyWhenRequiredComponentsReady(t *testing.T) {
	...
	report := controlplane.ReadinessReport{
		...
		Components: []controlplane.ReadinessComponentStatus{
			...
			{Component: controlplane.ReadinessComponentCustomerRater, State: controlplane.CapabilityReady},
			{Component: controlplane.ReadinessComponentOperatorRater, State: controlplane.CapabilityReady},
