...
Write-Host "[1/4] Checking Go formatting..." -ForegroundColor Yellow
...
Write-Host "[2/4] Checking Go modules..." -ForegroundColor Yellow
go mod tidy
...
Write-Host "[3/4] Checking build..." -ForegroundColor Yellow
...
Write-Host "[4/4] Running go vet..." -ForegroundColor Yellow
