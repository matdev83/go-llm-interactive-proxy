...
var (
	...
	ErrAuthoritativeBillingRequired        = errors.New("runtimebundle: authoritative billing requires one durable BillingStore, cheap credit screen, exposure admission, terminal usage appenders, immutable rating snapshots, and a resource ledger")
