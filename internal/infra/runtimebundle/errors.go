...
var (
	...
	ErrBillingAdmissionRequired            = errors.New("runtimebundle: billing admission is required but ProductionOptions.BillingAdmission is nil")
	ErrBillingTerminalIdentityRequired     = errors.New("runtimebundle: billing terminal handoff requires explicit BillingIdentity account and authorization resolvers")
	ErrAuthoritativeBillingRequired        = errors.New("runtimebundle: authoritative billing requires one BillingStore implementing handoff, processing, settlement, and reports, plus admission, identities, rating snapshots, and a resource ledger")
