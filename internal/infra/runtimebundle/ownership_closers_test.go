...
var closerAcquisitionOwnership = []ownershipEntry{
	...
	},
	{
		...
		Class:  ownershipProcess,
		Source: "build.go → buildControlPlaneRuntime",
		Notes:  "Process durable control-plane store teardown.",
	},
	{
		Symbol: "build.go:Build:acq#1:append(closers, usageClosers...)#0",
		Class:  ownershipProcess,
		Source: "build.go → buildUsageAuthorityRuntime",
		Notes:  "Process authority store/resources.",
	},
	{
		Symbol: "build.go:Build:acq#2:append(closers, concurrencyClosers...)#0",
		Class:  ownershipProcess,
		Source: "build.go → buildConcurrencyAuthorityRuntime",
		Notes:  "Process concurrency store/resources.",
	},
	{
		Symbol: "build.go:Build:acq#3:append(closers, twClosers...)#0",
		Class:  ownershipProcess,
		Source: "build.go → buildTerminalWorkWithSetReconcile",
		Notes:  "Process terminal-work processor shutdown.",
	},
	{
		Symbol: "build.go:Build:acq#4:append(closers, func:postgresPools.Close|context.Background)#0",
		Class:  ownershipProcess,
		Source: "build.go",
		Notes:  "Process database pool registry.",
	},
	{
	...
	},
	{
		...
		Notes:  "Process metering journal/resources.",
	},
	{
		...
		Notes:  "Generation-owned backend Close registration.",
	},
	{
		Symbol: "build_model.go:buildBackends:acq#0:append(constructedClosers, be.Close)#0",
		Class:  ownershipGeneration,
		Source: "build_model.go → buildBackends",
		Notes:  "Rollback bag for partially constructed backends.",
	},
	{
		Symbol: "build_model.go:buildModelRuntime:acq#0:append(closers, startedCatalog.closers...)#0",
		Class:  ownershipGeneration,
		Source: "build_model.go → startedCatalog.closers",
		Notes:  "Candidate catalog runtime cleanup; quiesced with retired generation (task 4.5).",
	},
	{
		Symbol: "build_model.go:buildModelRuntime:acq#1:append(closers, modelRegistryClosers...)#0",
		Class:  ownershipGeneration,
	...
	{
		Symbol: "build_model.go:startModelRegistryRuntime:acq#0:append(closers, func:refreshCancel|refreshWG.Wait)#0",
		Class:  ownershipGeneration,
		Source: "build_model.go → startModelRegistryRuntime",
		Notes:  "Generation refresh-loop cancel/wait.",
	},
	{
	...
	{
		Symbol: "modelcatalog_attach.go:startModelCatalog:acq#1:append(out.closers, func:refreshCleanup)#0",
		Class:  ownershipGeneration,
		Source: "modelcatalog_attach.go → startModelCatalog",
		Notes:  "Candidate catalog refresh cleanup registered on attach runtime.",
	},
	{
