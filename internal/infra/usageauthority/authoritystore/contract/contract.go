...
func strictReserveCommand(source string, amount int64, seq int) app.ReserveCommand {
	return app.ReserveCommand{
		...
		Spend:        domain.Amount{Unit: domain.AmountUnitMoneyNano, Value: amount * 10, Currency: "usd"},
...
func strictSettleCommand(reservationID, source string, finalUsage, reservedUsage, estimatedUsage int64) app.SettleCommand {
	return app.SettleCommand{
		...
		FinalCost:      domain.Amount{Unit: domain.AmountUnitMoneyNano, Value: finalUsage * 10, Currency: "usd"},
		...
		EstimatedCost:  domain.Amount{Unit: domain.AmountUnitMoneyNano, Value: estimatedUsage * 10, Currency: "usd"},
		Authority:      domain.AuthorityLevelAuthoritative,
...
func noWindowReserveCommand(source string) app.ReserveCommand {
	return app.ReserveCommand{
		...
		Request:      domain.Amount{Unit: domain.AmountUnitMoneyNano, Value: 100},
		Spend:        domain.Amount{Unit: domain.AmountUnitMoneyNano, Value: 100, Currency: "usd"},
		Authority:    domain.AuthorityLevelAuthoritative,
		EstimateOnly: false,
		At:           contractBaseTime,
		SourceKey:    source,
