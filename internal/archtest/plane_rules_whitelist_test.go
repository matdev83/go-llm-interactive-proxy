...
func TestAllowedStageConsumers_AllWhitelistedEntriesExercised(t *testing.T) {
	...
	fixtures := []fixture{
		...
		{
			qualSym:   "internal/core/extensions.(*RequestRuntimeSnapshot).SecretGuardPlane",
			relPath:   "internal/core/extensions/snapshot.go",
			planeID:   "secret_guards",
			planeExpr: "lipfeature.PlaneSecretGuards",
			wave:      Wave5a_GuardsCompaction,
			isMethod:  true,
			funcName:  "SecretGuardPlane",
		},
		{
			qualSym:   "internal/core/extensions.(*RequestRuntimeSnapshot).SecretGuardExecutionPlane",
			relPath:   "internal/core/extensions/snapshot.go",
			planeID:   "secret_guards",
			planeExpr: "lipfeature.PlaneSecretGuards",
			wave:      Wave5a_GuardsCompaction,
			isMethod:  true,
			funcName:  "SecretGuardExecutionPlane",
		},
		{
