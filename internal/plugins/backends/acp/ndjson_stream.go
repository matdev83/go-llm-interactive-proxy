...
// Cancel is the leglifecycle.BLegAttempt hook. It delegates to the strategy's
// OnCancel and reports provider-mode cancellation.
func (b *NDJSONStreamBase) Cancel(ctx context.Context, cause leglifecycle.CancelCause) leglifecycle.CancelResult {
	b.strategy.OnCancel()
