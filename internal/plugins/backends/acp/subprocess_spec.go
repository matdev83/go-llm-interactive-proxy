...
func NewSubprocessBackend(cfg SubprocessBackendConfig) *subprocessBackend {
	log := cfg.Log
	if log == nil {
		log = cfg.Pool.Log
	}
...
func (s *poolManagedStream) Cancel(ctx context.Context, cause leglifecycle.CancelCause) leglifecycle.CancelResult {
