...
func TestInventory_NormalizeSanitizedFixture(t *testing.T) {
	...
	be := cursorsdk.NewScaffold(mustConfig(t)).WithModelListSource(cursorsdk.StaticModelListSource{Rows: rows}).Backend()
...
func TestInventory_RejectEmptyAndDuplicateIDs(t *testing.T) {
	t.Parallel()
	be := cursorsdk.NewScaffold(mustConfig(t)).WithModelListSource(cursorsdk.StaticModelListSource{
...
func TestInventory_UnreachableBridgeOperationalFailSoft(t *testing.T) {
	...
	be := cursorsdk.NewScaffold(cfg).Backend()
...
func TestInventory_FailedReloadKeepsLastKnownGoodCatalog(t *testing.T) {
	...
	be := cursorsdk.NewScaffold(mustConfig(t)).WithModelListSource(src).Backend()
	snap, err := be.ModelInventory.LoadModels(context.Background())
	if err != nil {
...
func TestScaffold_TrackingInventoryType(t *testing.T) {
	t.Parallel()
	be := cursorsdk.NewScaffold(mustConfig(t)).Backend()
...
func mustConfig(t *testing.T) cursorsdk.Config {
	t.Helper()
