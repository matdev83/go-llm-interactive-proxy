  ...
  "output": [
    {
      ...
      "status": "completed",
      "role": "assistant",
      "content": [{"type": "output_text", "text": "provider-mode-ok"}]
    }
  ],
...
func openAIResponsesCompatSSE(created int64) string {
	...
	return "event: response.created\n" +
		...
		"data: " + `{"type":"response.output_item.added","sequence_number":2,"output_index":0,"item":{"type":"message","id":"msg_provider_1","status":"in_progress","role":"assistant","content":[{"type":"output_text","text":""}]}}` + "\n\n" +
		"event: response.content_part.added\n" +
		"data: " + `{"type":"response.content_part.added","sequence_number":3,"item_id":"msg_provider_1","output_index":0,"content_index":0,"part":{"type":"output_text","text":""}}` + "\n\n" +
		"event: response.output_text.delta\n" +
		"data: " + `{"type":"response.output_text.delta","sequence_number":4,"item_id":"msg_provider_1","output_index":0,"content_index":0,"delta":"` + txt + `"}` + "\n\n" +
		"event: response.output_text.done\n" +
		"data: " + `{"type":"response.output_text.done","sequence_number":5,"item_id":"msg_provider_1","output_index":0,"content_index":0,"text":"` + txt + `"}` + "\n\n" +
		"event: response.content_part.done\n" +
		"data: " + `{"type":"response.content_part.done","sequence_number":6,"item_id":"msg_provider_1","output_index":0,"content_index":0}` + "\n\n" +
