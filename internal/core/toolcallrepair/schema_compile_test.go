...
func TestCompile_UnsupportedDialect(t *testing.T) {
	...
	assertSchemaKind(t, err, toolcallrepair.SchemaKindUnsupported)
}
...
func TestCompile_ExternalRefRejectedWithoutIO(t *testing.T) {
	...
	_, err := cache.GetOrCompile(schema)
	assertSchemaKind(t, err, toolcallrepair.SchemaKindExternalRef)
}
...
func TestCompile_UnsafeDynamicRef(t *testing.T) {
	...
	_, err := cache.GetOrCompile(schema)
	assertSchemaKind(t, err, toolcallrepair.SchemaKindUnsafe)
}
...
func TestCompile_Limits(t *testing.T) {
	...
	t.Run("schema_bytes", func(t *testing.T) {
		...
		assertSchemaKind(t, err, toolcallrepair.SchemaKindLimitExceeded)
	})
	...
	t.Run("local_ref_depth", func(t *testing.T) {
		...
		assertSchemaKind(t, err, toolcallrepair.SchemaKindLimitExceeded)
		var se *toolcallrepair.SchemaError
		if !errors.As(err, &se) || se.ReasonCode != toolcallrepair.ReasonLocalRefTooDeep {
...
func TestCompile_Malformed(t *testing.T) {
	...
	t.Run("json", func(t *testing.T) {
		...
		assertSchemaKind(t, err, toolcallrepair.SchemaKindMalformed)
	})
...
func TestDefaultSchemaLimits(t *testing.T) {
	t.Parallel()
	l := toolcallrepair.DefaultSchemaLimits()
