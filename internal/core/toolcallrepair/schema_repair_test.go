...
func TestEngine_PatternPropertyInvalidValueNotDropped(t *testing.T) {
	...
	if out.Kind != toolcallrepair.OutcomeUnrepairable || out.ReasonCode != toolcall.ReasonScalarCoercionDisabled {
...
func TestEngine_RefDefaultInserted(t *testing.T) {
	...
	if out.Kind != toolcallrepair.OutcomeRewrite || out.ReasonCode != toolcall.ReasonDefaultInserted {
