...
func TestEngine_CoreBehaviors(t *testing.T) {
	...
	cases := []struct {
		...
		wantKind       toolcallrepair.OutcomeKind
		wantReason     string
	...
	}{
		{
			...
			wantKind:      toolcallrepair.OutcomePass,
		...
		},
		{
			...
			wantKind:       toolcallrepair.OutcomeUnrepairable,
		...
		},
		{
			...
			wantKind:       toolcallrepair.OutcomeRewrite,
...
func TestEngine_ResolvedToolExactFastPath(t *testing.T) {
	...
	t.Run("uses_provided_tool_with_empty_catalog", func(t *testing.T) {
		...
		if out.Kind != toolcallrepair.OutcomePass || out.ReasonCode != toolcall.ReasonValidPassThrough {
	...
	t.Run("name_mismatch_falls_back_to_catalog_normalize", func(t *testing.T) {
		...
		if out.Kind != toolcallrepair.OutcomeRewrite || out.ReasonCode != toolcall.ReasonToolNameNormalized {
	...
	t.Run("ambiguous_normalized_still_unrepairable", func(t *testing.T) {
		...
		if out.Kind != toolcallrepair.OutcomeUnrepairable || out.ReasonCode != toolcall.ReasonAmbiguousToolName {
...
func TestEngine_PostRepairArgsTooLarge(t *testing.T) {
	...
	if out.Kind != toolcallrepair.OutcomeUnrepairable || out.ReasonCode != toolcall.ReasonArgsTooLarge {
