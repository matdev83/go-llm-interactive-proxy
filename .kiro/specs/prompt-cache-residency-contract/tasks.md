...
- [ ] 1.1 Define RED lifecycle/profile/validation tests
...
- [ ] 1.2 (P) Define RED observation and identity-isolation tests
...
- [ ] 1.3 (P) Define RED control-handle and affinity tests
...
- [ ] 1.4 (P) Define RED executable-connector compatibility tests
...
- [ ] 2.1 Implement the residency profile, observation, evidence, and control contracts
...
- [ ] 2.2 Add optional effective backend residency/control capability
...
- [ ] 2.3 Add the one-shot host-only observation source contract
...
- [ ] 3.1 Add negotiated residency profile and observation sideband support
...
- [ ] 3.2 Add optional instance-scoped renew/release control operations
...
- [ ] 3.3 Reuse provider-billable accounting for control usage
...
- [ ] 4.1 Build an in-process reference residency/controller implementation
...
- [ ] 4.2 (P) Build an executable reference connector implementation
...
- [ ] 4.3 Consolidate the residency contract TCK
...
- [ ] 5.1 Add architecture/security guards against abstraction leakage
...
- [ ] 5.2 Run compatibility, race/leak, and repository quality gates
...
- [ ] 5.3 Perform final foundation-scope review
