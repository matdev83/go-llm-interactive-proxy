...
- **Additional frontend contract tests (2026-04-20):** `TestDecodeCreate_inputString`, `TestDecodeCreate_instructionsNonStringRejected`; HTTP handler `TestIntegration_invalidPath_returns404`, `TestIntegration_methodNotAllowed`.
...
- **Additional frontend contract tests (2026-04-20):** `TestDecodeChat_streamOptionsExtension`; HTTP handler `TestIntegration_invalidPath_returns404`, `TestIntegration_methodNotAllowed`.
...
- **Additional frontend contract tests (2026-04-20):** `TestDecodeMessage_systemBlockArray` (system as JSON array of `type: text` blocks), `TestDecodeMessage_unsupportedRole`; HTTP handler `TestIntegration_invalidPath_returns404`.
...
- **Additional frontend contract tests (2026-04-20):** `TestDecodeGenerateContent_generationConfig`; non-stream JSON omits `usageMetadata` even when the canonical stream includes usage (`TestWriteNonStreamJSON_textFromStream`, `TestWriteNonStreamJSON_ignoresUsageFromStream`).
