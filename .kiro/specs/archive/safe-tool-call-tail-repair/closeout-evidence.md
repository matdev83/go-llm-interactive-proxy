...
- The full-repo strict Linux race gate is red on `main` for pre-existing, unrelated failures; changed packages pass under `-race` and this is recorded as an explicit blocker rather than a green-race claim.
