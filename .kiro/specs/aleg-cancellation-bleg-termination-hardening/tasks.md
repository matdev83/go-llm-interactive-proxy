...
- [x] 1.1 Revalidate the merged #428 ownership baseline at implementation start
...
- [x] 1.2 (P) Add RED tests for cancel-vs-provider-launch linearization
...
- [x] 1.3 (P) Add RED tests for sibling fan-out and physical CancelResult fidelity
...
- [x] 1.4 (P) Add RED backend-plugin tests proving CANCEL is not an active-Execute handshake
...
- [x] 1.5 (P) Add RED tests for terminal provider-sideband billing evidence
...
- [x] 2.1 Implement the A-leg single-use B-leg launch permit
...
- [x] 2.2 Integrate the permit into every provider activation path and transfer successful Open ownership early
...
- [x] 2.3 Replace serial active-child teardown with bounded concurrent A-leg fan-out
...
- [x] 2.4 Propagate the physical stream `CancelResult` through the #428 terminal owner
...
- [x] 2.5 Certify the core cancellation race matrix before crossing the process boundary
...
- [x] 3.1 (P) Add the next additive backend-plugin cancellation feature/minor and wire mode
...
- [x] 3.2 Refactor `ForwardExecute` into an active-Execute control/upstream coordinator
...
- [x] 3.3 Strengthen the connector contract TCK around active cancellation
...
- [x] 4.1 Implement attempt-local cancellation progress state in the backend-plugin adapter
...
- [x] 4.2 Implement graceful-to-force `Cancel` and deterministic `Close`
...
- [x] 4.3 (P) Upgrade standard connector feature advertisements and backend-family cancellation-mode contracts
...
- [x] 5.1 Introduce/refactor the bounded attempt-owned provider-evidence accumulator
...
- [x] 5.2 Route normal sideband drain through the attempt-owned accumulator
...
- [x] 5.3 Drain remaining sideband evidence inside the single attempt terminal owner
...
- [x] 5.4 Feed aggregated provider evidence into existing exactly-once terminal B-leg billing precedence
...
- [x] 6.1 Reconcile intentional cancellation with recovery/error classification
...
- [x] 6.2 (P) Add bounded cancellation diagnostics and metrics
...
- [x] 7.1 Ratchet A-leg launch authority and #428 attempt ownership
...
- [x] 7.2 (P) Ratchet cancellation ABI/result fidelity and evidence ownership
...
- [x] 8.1 Run the complete runtime cancellation concurrency certification
...
- [x] 8.2 Run backend-plugin and connector cancellation certification
...
- [x] 8.3 Run terminal billing/evidence certification
...
- [x] 8.4 Run final repository gates and produce implementation evidence
