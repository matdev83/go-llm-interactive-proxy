...
- [ ] 1. Canonical event model for the thinking signature
- [ ] 1.1 Add `EventReasoningSignatureDelta` kind, `Signature` field, and envelope bound
...
- [ ] 1.2 Register the kind in both canonical sequence validators
...
- [ ] 1.3 Collector no-op and output-commit exclusion
...
- [ ] 2. Anthropic backend signature capture (P)
- [ ] 2.1 Capture `anthropic.SignatureDelta`
...
- [ ] 3. Anthropic frontend stream signature emission (P)
- [ ] 3.1 Emit `signature` and `signature_delta` on the thinking block
...
- [ ] 4. Non-Anthropic frontend no-op regression tests (P)
- [ ] 4.1 Assert the signature signal is silently ignored by other frontends
...
- [ ] 5. Parity and end-to-end validation
- [ ] 5.1 Parity: Anthropic frontend x Anthropic backend signature round-trip
...
- [ ] 5.2 End-to-end with `cmd/lipstd` and an Anthropic refbackend stub
...
- [ ] 6. Quality gate and PR
- [ ] 6.1 Run the quality and parity gates
...
- [ ] 6.2 Open a focused PR and babysit CI
