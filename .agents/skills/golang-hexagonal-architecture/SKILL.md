...
description: Go-specific hexagonal architecture skill for designing and reviewing maintainable large-scale applications. Use when a project has explicitly chosen ports-and-adapters / hexagonal architecture and you need concrete guidance on dependency direction, use-case boundaries, repository and query seams, anti-corruption layers, transaction boundaries, composition roots, and other Go-specific implementation rules.
---
