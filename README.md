...
| Local-agent / experimental | External `cursorcliacp` connector; experimental in-tree `cursorsdk` adapter (Node bridge over `@cursor/sdk` 1.0.23) is opt-in outside `EssentialBackendBundle` — see [`docs/cursor-sdk-backend.md`](docs/cursor-sdk-backend.md) |
