...
import (
	...
	"github.com/matdev83/go-llm-interactive-proxy/connectors/codex/internal/localtok/countapp"
	"github.com/matdev83/go-llm-interactive-proxy/connectors/codex/internal/localtok/imageestimator"
	"github.com/matdev83/go-llm-interactive-proxy/connectors/codex/internal/localtok/tiktoken"
...
func (e *usageEstimator) estimateUsage(ctx context.Context, call lipapi.Call, model, outputText string) (lipapi.Event, error) {
	callResult, err := e.counter.CountCall(ctx, countapp.CountCallInput{Call: call, Model: model})
	if err != nil {
		return lipapi.Event{}, err
	}
	outputResult, err := e.counter.CountOutput(ctx, countapp.CountOutputInput{Model: model, Text: outputText})
	if err != nil {
		return lipapi.Event{}, err
	}
