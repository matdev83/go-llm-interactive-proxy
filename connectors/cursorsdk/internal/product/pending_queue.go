...
var ErrPendingQueueFull = errors.New("cursorsdk: pending event queue capacity exceeded")

// PendingEventQueue buffers canonical events for bridge→lipapi translation that
// expands one wire frame into zero or more events. It avoids slice-prefix dequeue
// which retains a large backing array over long streams.
